    ...
    return (
        <div className='tr' onClick={onRowClickHandler}>
            ...
            <div className='td-buttons'>
                <div className='td-edit' onClick={onUpdateButtonClickHandler}>
...
export default function HR() {
    ...
    const {
        ...
        setTotalList, initViewList, ...paginationProps // ...paginationProps : 나머지 속성들은 'paginationProps'이름으로 묶어서 가져옴 
    } = usePagination<Nurse>();
            ...
            <div className='main'>
                <div className='table'>
                    <div className='th'>
                        ...
                        <div className='td-nurse-infos'>
                            <div className='td-nurse-id'>요양사 아이디</div>
