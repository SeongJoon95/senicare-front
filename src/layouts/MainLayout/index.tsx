...
import { ACCESS_TOKEN, AUTH_ABSOLUTE_PATH, AUTH_PATH, CS_PATH, HR_PATH, MM_PATH, ROOT_ABSOLUTE_PATH } from 'src/constants';
...
function Top() {
    ...
    // variable : 경로 이름 //
    const path = pathname.startsWith(CS_PATH) ? '고객 관리' : 
